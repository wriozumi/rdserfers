    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-900">
          {{ formatDateLong(parseDate(booking.pickupDate)) }}
        </p>
        <p class="text-xs text-gray-500">
          {{ formatTimeFromString(booking.pickupDate) }}
        </p>
      </div>
      ...
      <div>
        ...
        >
        <p class="mt-1 text-sm text-gray-900">
          {{ formatDateLong(parseDate(booking.returnDate)) }}
        </p>
        <p class="text-xs text-gray-500">
          {{ formatTimeFromString(booking.returnDate) }}
        </p>
      </div>
